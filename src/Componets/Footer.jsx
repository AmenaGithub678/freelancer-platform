...
const Footer = () => {
    return (
<footer className="footer footer-horizontal footer-center bg-[#FFBDA1] text-base-content rounded p-10 ">
...
<div className="flex items-center justify-center gap-2 text-base font-medium text-[#0F0F0FB3]">
  ...
  <aside>
    <p>Copyright © {new Date().getFullYear()} - All right reserved by @Meem@</p>
  </aside>
</footer>
    );
};
